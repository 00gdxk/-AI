          ...
          {imageGenProgress && imageGenProgress.total > 0 && imageGenProgress.current < imageGenProgress.total && (
            <div className="bg-indigo-50 border border-indigo-100 px-4 py-2 rounded-xl flex items-center shadow-sm">
              ...
              <span className="text-sm font-bold text-indigo-700">
                Processing visuals: {imageGenProgress.current} / {imageGenProgress.total}
              </span>
            </div>
          )}
        </header>
                      ...
                      {slide.imageSource && (
                        <div className="absolute top-2 left-2 z-20">
                          <a 
                            ...
                            className="bg-black/60 backdrop-blur-md text-[10px] text-white px-2 py-1 rounded-lg border border-white/20 hover:bg-black/80 transition-colors"
                          >
